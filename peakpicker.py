...
def peak_pick (S,f_dim1,t_dim1,f_dim2,t_dim2,threshold,base):
    ...
    "f_dim1,f_dim2,t_dim1,and t_dim2 are freq x time dimensions of the sliding window for first and second pastes"
    ...
    "Determine the time x frequency window to astyze"
